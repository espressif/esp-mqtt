...
typedef struct {
    ...
    const char *client_cert_pem;            /*!< pointer to client CERT file for SSL mutual authentication (not required), default is NULL */
    const char *client_key_pem;             /*!< pointer to client KEY file for SSL mutual authentication (not required), default is NULL */
