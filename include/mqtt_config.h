...
#ifdef CONFIG_MQTT_SILENCE_LIBRARY
#define ESPMQTT_LOGE(...)
#define ESPMQTT_LOGW(...)
#define ESPMQTT_LOGI(...)
#define ESPMQTT_LOGD(...)
#define ESPMQTT_LOGV(...)
#else
#define ESPMQTT_LOGE ESP_LOGE
#define ESPMQTT_LOGW ESP_LOGW
#define ESPMQTT_LOGI ESP_LOGI
#define ESPMQTT_LOGD ESP_LOGD
#define ESPMQTT_LOGV ESP_LOGV
#endif
